    ...
    public static List<CustomAgentConfig> Build(RalphLoopConfig config, bool includeUxDesigner)
    {
        var personas = new List<CustomAgentConfig>
        {
            new()
            {
                ...
                Description = "Owns the PRD. Validates story alignment with requirements. Flags scope drift.",
                Prompt = "You are John, the Product Manager. You own prd.md. " +
            ...
            new()
            {
                ...
                Description = "Implements stories. Identifies technical ambiguities and implementation risks.",
                Prompt = "You are Amelia, the senior developer. " +
            ...
            new()
            {
                ...
                Description = "Answers architectural questions and validates alignment with architecture.md.",
                Prompt = "You are Winston, the Software Architect. " +
            ...
            new()
            {
                ...
                Prompt = "You are Paige, the Technical Writer. " +
            ...
            new()
            {
                ...
                Prompt = "You are the Skeptic. Your job is to challenge every assumption. " +
            ...
            new()
            {
                ...
                Prompt = "You are the Edge Case Hunter. " +
        ...
        if (includeUxDesigner)
        {
            personas.Add(new()
            {
                ...
                Prompt = "You are Sally, the UX Designer. " +
